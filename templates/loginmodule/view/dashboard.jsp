						...
						<div class="card text-white bg-primary">
							...
							<div class="chart-wrapper mt-3 mx-3" style="height: 70px;">
								...
								<div id="card-chart1-tooltip" class="chartjs-tooltip top"
									style="opacity: 0; left: 158.558px; top: 128.111px;">
									...
									<div class="tooltip-body">
										<div class="tooltip-body-item">
											<span class="tooltip-body-item-color"
												...
												class="tooltip-body-item-value">51</span>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="card text-white bg-info">
							...
							<div class="chart-wrapper mt-3 mx-3" style="height: 70px;">
								...
								<div id="card-chart2-tooltip" class="chartjs-tooltip top"
									style="opacity: 0; left: 56.5576px; top: 115.837px;">
									<div class="tooltip-header">
									...
									<div class="tooltip-body">
										<div class="tooltip-body-item">
											<span class="tooltip-body-item-color"
												...
												class="tooltip-body-item-label">My First dataset</span><span
												class="tooltip-body-item-value">18</span>
										</div>
									</div>
								</div>
							</div>
